package ultrasclaimprotection.utils.teleportation;
...
public class DelayedTeleport extends JavaPlugin {
    ...
    public static void create(Player player, Location location, String message) {
        ...
        BukkitTask task = Bukkit.getScheduler().runTaskTimer(UltrasClaimProtection.getPlugin(UltrasClaimProtection.class), () -> {
