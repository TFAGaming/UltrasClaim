package veloxclaimprotection.utils.particles;
...
import veloxclaimprotection.utils.flags.PlayerFlags;

public class ChunkParticles {
    private static VeloxClaimProtection plugin = VeloxClaimProtection.getPlugin(VeloxClaimProtection.class);
